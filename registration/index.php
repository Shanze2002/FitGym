    ...
    if ($check->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            echo "<script>
                ...
                window.location='http://localhost/FITGYM/loging/index.php';
            </script>";
        } else {
...
<div class="form-container">
    ...
    <form method="POST" action="">
        ...
        <div class="d-grid mt-2">
            <a href="http://localhost/FITGYM/loging/index.php" class="btn btn-secondary">Back to Home</a>
        </div>

        <div class="d-grid mt-2">
            <a href="http://localhost/FITGYM/loging/index.php" class="btn btn-primary">Go to Login Page</a>
        </div>
    </form>
</div>
