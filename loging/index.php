...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->num_rows === 1) {
        ...
        if (password_verify($password, $hashedPassword)) {
            ...
            header("Location: http://localhost/FITGYM/main/index.php");
            exit;
        } else {
...
<div class="login-box">
    ...
    <div class="text-center btn-register">
        <a href="http://localhost/FITGYM/registration.php" class="btn btn-outline-primary w-100">Don't have an account? Register</a>
    </div>
</div>
